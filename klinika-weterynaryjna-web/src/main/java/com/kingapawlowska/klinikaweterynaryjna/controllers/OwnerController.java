...
//            model.addAttribute("selections", results);
             ...
             */
//            Comparator<Owner> compareById = Comparator.comparing(BaseEntity::getId);
//            ownerList.sort(compareById.reversed());
    ...
    public String initDeleteForm(@PathVariable Long ownerId, Model model) {
        model.addAttribute("pet", ownerService.findById(ownerId));
